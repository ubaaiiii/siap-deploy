...
if (isset($_SESSION['idLevel']))
{
    if ($_SESSION['idLevel'] == "super_user")
    {
        ...
        echo "<li><a href='media.php?module=msprofile'><i class='fa fa-search'></i> Mitra </a></li>";
    ...
    elseif ($_SESSION['idLevel'] == "broker")
    {
        ...
        echo "<li><a><i class='fa fa-wrench'></i> Master<span class='fa fa-chevron-down'></span></a>";
        echo "<ul class='nav child_menu'>";
		echo "<li><a href='media.php?module=msprofile'><i class='fa fa-book'></i> Profile</a></li>";
		echo "<li><a href='media.php?module=mspolis'><i class='fa fa-book'></i> Polis</a></li>";
