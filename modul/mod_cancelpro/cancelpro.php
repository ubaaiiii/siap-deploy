		 ...
		 $(document).ready(function() {
		  $("#txtcari").keyup(function() {
		   ...
		   $("#tabel_awal").css("display", "none");
			...
			$.ajax({
			 type:"post",
			 url:"modul/mod_cancelpro/cari.php",
			 data:"q="+ strcari,
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
										...
										<?php
										/* 7	INPUT PEMBATALAN 
										71	PEMBATALAN APPROVAL
										72	PEMBATALAN VERIFIKASI
										73	PEMBATALAN VALIDASI
										8	INPUT REFUND
										81	REFUND APPROVAL
										82	REFUND VERIFIKASI
										83	REFUND VALIDASI */
											...
											if ($vlevel=="insurance"   )
											{
												$sqlr= $sqlr . " where aa.status='73'  or aa.status='83'";
										...
										?>
                                            <tr>
                                                ...
                                                <th>
												<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Edit" onclick="window.location='media.php?module=cancelpro&&act=view&&id=<?php echo $r['regid']; ?>'"><i class="fa fa-search"></i> View</button>
												...
												<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="form" onclick="window.location = 'laporan/batal/f_batal.php?id=<?php echo $r['regid']; ?>'"><i class="fa fa-print"></i> Form</button>
												
												<button type="button" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Rollback" onclick="window.location='<?php echo $aksi."?module=rollback&&id=".$r['regid'] ."&&lvl=" . $vlevel  ; ?>'"><i class="fa fa-trash"></i> Rollback</button>
												</th>
...
$sqle="select aa.*,ab.tglbatal,ab.masa smasa,ab.sisa,ab.refund,ab.reason,ab.catreason ,ac.msdesc resdesc ";
									...
									<input type="hidden" name="produk" value="<?php echo $sproduk; ?>">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
												...
												<?php
												$sqlcmb="select distinct  ms.msid comtabid,msdesc comtab_nm from ms_master ms where ms.mstype='batal'  order by ms.mstype ";
												$query=mysql_query($sqlcmb);
												while($bariscb=mysql_fetch_array($query)){
												?>
...
$sqle= $sqle . " aa.premi,aa.epremi,aa.tpremi,aa.bunga,aa.tunggakan,aa.produk,aa.mitra,aa.comment,aa.asuransi,aa.policyno , ab.catreason sbatal,ab.tglbatal tglbatal,ab.reason ";
$sqle= $sqle . " from tr_sppa aa inner join tr_sppa_cancel ab on ab.regid=aa.regid ";
                ...
                <div class="">
                   ...
                   <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Add Pembatalan <small><?php echo $sid; ?></small></h2>
									...
									<input type="hidden" name="produk" value="<?php echo $sproduk; ?>">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
												...
												<option value="" selected="selected">-- choose category --</option>
												<?php
												$sqlcmb="select distinct  ms.msid comtabid,msdesc comtab_nm from ms_master ms where ms.mstype='batal'  order by ms.msdesc ";
												$query=mysql_query($sqlcmb);
												while($bariscb=mysql_fetch_array($query)){
												?>
												<option value="<?=$bariscb['comtabid']?>" <? if($bariscb['comtabid']==$sbatal){ ?> selected="selected" <? }?>> 
