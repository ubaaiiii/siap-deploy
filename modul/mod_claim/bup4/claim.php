                			  ...
                			  {                         // full[11] => Aksi
                				"mRender": function ( data, type, full ) {
                				    ...
                				    if ('<?=$vlevel;?>' == 'broker' && (status == '91' || status == '90')) {
                				        button += `<a class="btn-approve btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" title="Approve" data-regid="`+full[1]+`" data-id="`+full[0]+`"><i class="fa fa-check"></i> `+kelengkapan+`</a>`;
                				        if (status == '91') {
