    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <!--<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Add" onclick="window.location='media.php?u=<?=encrypt_decrypt('encrypt','module:claimpro');?>'"><i class="fa fa-plus-circle"></i> Add</button>-->
            ...
            <div class="x_content">
                ...
                <script>
        //             function render_link(linknya) {
        //                 var tmp = null;
				    //     $.ajax({
				    //         async: false,
				    //         global: false,
				    //         url : "config/fungsi_all.php",
				    //         data: {"encrypt":linknya,"token":'<?=$_SESSION['token'];?>'},
				    //         type: "POST",
                        ...
                        var tableClaim = $('#table-claim').DataTable({
                			...
                			"aoColumns": [
                			  ...
                			  {                         // full[11] => Aksi
                				"mRender": function ( data, type, full ) {
                				    data = data.split('-');
                				    // var regclaim= render_link(data[0]),
                				    //     regid   = render_link(data[1]),
                				    var regclaim= data[0],
                				        regid   = data[1],
                				        status  = data[2],
                				        nama    = data[3];
                				    ...
                				    if (('<?=$vlevel;?>' == 'broker' && (status == '90' || status == '91')) || ('<?=$vlevel;?>' == 'checker' && status == '90')) {
                				        // var button = `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Ubah Data" href="media.php?u=`+render_link('module:claim,act:update,id:'+full[1])+`"><i class="fa fa-edit"></i> Edit</a>`;
                				        ...
                				        // var button = `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Lihat Data" href="media.php?u=`+render_link('module:claim,act:view,id:'+full[1])+`"><i class="fa fa-search"></i> View</a>`;
                				    ...
                				    // button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="View Documents" href="media.php?u=`+render_link(`module:doc,id:`+full[1]+`,jenis:DTCLM`)+`"><i class="fa fa-files-o"></i> Doc</a>`;
                				    ...
                				    if ('<?=$vlevel;?>' == 'broker' && status == '91') {
                				        button += `<a class="btn-approve btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" title="Approve" data-regid="`+regid+`" data-id="`+regclaim+`"><i class="fa fa-check"></i> Approve</a>`;
                				    ...
                				    if ('<?=$vlevel;?>' == 'insurance') {
                				        if (status == '90') {
                				            ...
                				            button += `<a class="btn-approve-ins btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" title="Approve" data-regid="`+regid+`" data-id="`+regclaim+`"><i class="fa fa-check"></i> Approve</a>`;
                				    ...
                				    // button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="History Log" href="media.php?u=`+render_link(`module:polhist,act:log,type:LTCLM,id:`+full[1])+`"><i class="fa fa-history"></i> Log</button>`;
...
default:
    // header("location:media.php?u=".encrypt_decrypt('encrypt','module:claim'));
                        ...
                        <form method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?= $aksi."?module=".$action; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="hidden" id="insurance" name="insurance" readonly required value="<?= $r['asuransi']; ?>">
