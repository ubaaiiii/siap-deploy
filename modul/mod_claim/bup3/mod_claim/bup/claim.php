                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
										...
										<?php
											...
											if ($slevel=="schecker") 
											{												
											$sqlr= $sqlr . " where ab.status in ('90' ";
											}
											else
											{												
                                ...
                                <div class="x_content">
									...
									<input type="hidden" name="regid" value="<?php echo $sregid; ?>">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="date" id="tgllapor" name="tgllapor"  readonly required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $stgllapor; ?>">
