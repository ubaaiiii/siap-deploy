                			  ...
                			  {                         // full[11] => Aksi
                				"mRender": function ( data, type, full ) {
                				    ...
                				    if (('<?=$vlevel;?>' == 'broker' && (status == '90' || status == '91')) || ('<?=$vlevel;?>' == 'checker' && status == '90')) {
                				        var button = `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Ubah Data" href="media.php?module=claim&&act=update&&id=`+full[12]+`"><i class="fa fa-edit"></i> Edit</a>`;
                				        button += `<a class="btn-batal btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Batal Claim" data-id="`+full[12]+`"><i class="fa fa-times"></i> Batal</a>`;
                				    } else {
                				        var button = `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Lihat Data" href="media.php?module=claim&&act=view&&id=`+full[12]+`"><i class="fa fa-search"></i> View</a>`;
                				    }
                				    
                				    button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="View Documents" href="media.php?module=doc&&id=`+full[12]+`&&jenis=DTCLM"><i class="fa fa-files-o"></i> Doc</a>`;
                				    button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Download Checklist Document" href="laporan/claim/f_claim.php?id=`+full[12]+`"><i class="fa fa-download"></i> List</a>`;
                				    
                				    
                				    if ('<?=$vlevel;?>' == 'broker' && (status == '91' || status == '90')) {
                				        button += `<a class="btn-approve btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" title="Approve" data-regid="`+full[12]+`" data-id="`+full[0]+`"><i class="fa fa-check"></i> `+kelengkapan+`</a>`;
                				        if (status == '91') {
                    				        button += `<button type="button" class="btn-rollback btn btn-xs btn-warning" data-toggle="tooltip" data-placement="top" title="Rollback" data-id="`+full[12]+`" data-nama="`+nama+`"><i class="fa fa-undo"></i> Rollback</button>`;  
                				        }
                				    }
                				    
                				    if ('<?=$vlevel;?>' == 'schecker' && status == '90') {
                				        button += `<a class="btn-approve btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" title="Approve" data-regid="`+full[12]+`" data-id="`+full[0]+`"><i class="fa fa-check"></i> Approve</a>`;
                				    }
                				    
                				    if ('<?=$vlevel;?>' == 'insurance') {
                				        if (status == '90') {
                				            button += `<a class="btn-reject btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Reject" data-id="`+full[12]+`" data-nama="`+nama+`"><i class="fa fa-warning"></i> Expired</a>`;
                				        } else if (status == '92') {
                				            button += `<a class="btn-approve-ins btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" title="Approve" data-regid="`+full[12]+`" data-id="`+full[0]+`"><i class="fa fa-check"></i> Approve</a>`;
                    				        button += `<a class="btn-reject btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Reject" data-id="`+full[12]+`" data-nama="`+nama+`"><i class="fa fa-times"></i> Reject</a>`;
                    				        button += `<button type="button" class="btn-rollback btn btn-xs btn-warning" data-toggle="tooltip" data-placement="top" title="Rollback" data-id="`+full[12]+`" data-nama="`+nama+`"><i class="fa fa-undo"></i> Rollback</button>`;  
                				        } else if (status == '93') {
                				            button += `<a class="btn-receive btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Dokumen Telah Diterima" data-id="`+full[12]+`"><i class="fa fa-check-circle"></i> Received</a>`;
                				            button += `<a class="btn-reject btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Reject" data-id="`+full[12]+`" data-nama="`+nama+`"><i class="fa fa-times"></i> Reject</a>`;
                    				        button += `<button type="button" class="btn-rollback btn btn-xs btn-warning" data-toggle="tooltip" data-placement="top" title="Rollback" data-id="`+full[12]+`" data-nama="`+nama+`"><i class="fa fa-undo"></i> Rollback</button>`;  
                				        } else if (status == '96') {
                				            button += `<a class="btn-paid btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" data-nil="`+full[8]+`" data-id="`+full[12]+`" title="Pembayaran Claim"><i class="fa fa-calendar"></i> Paid</a>`;
                				        }
                				    }
                				    
                				    button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="History Log" href="media.php?module=polhist&&act=log&&type=LTCLM&&id=`+full[12]+`"><i class="fa fa-history"></i> Log</button>`;
