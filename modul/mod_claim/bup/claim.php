                    ...
                    $(document).ready(function(){
                        var tableClaim = $('#table-claim').DataTable({
                			...
                			"aoColumns": [
                			  ...
                			  {"sName": "status"},
                			  <?php if (in_array($vlevel,['schecker','checker'])){ ?>
                    			  {"sName": "sisawaktu","defaultContent": "<b><i>EXPIRED</i></b>"},
                    		  <?php } else { ?>  
                    			  {"sName": "jatuhtempo","defaultContent": "<b><i>EXPIRED</i></b>"},
                			  <?php } ?>
                			  {
                				"mRender": function ( data, type, full ) {
                				    data = data.split('-');
                				    ...
                				    if ('<?=$vlevel;?>' != 'checker') {
                				        button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Download Checklist Document" target="_blank" href="laporan/claim/f_claim.php?id=`+regid+`"><i class="fa fa-download"></i> List</a>`;
                				    }
                				    ...
                				    if ('<?=$vlevel;?>' == 'insurance') {
                				        if (status == '90') {
                				            ...
                				            button += `<a class="btn-paid btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" data-id="`+regid+`" title="Pembayaran Claim"><i class="fa fa-calendar"></i> Paid</a>`;
                				        }
                				    }
