...
$query=$db->query("SELECT a.nama FROM tr_sppa a WHERE regid='$sid'");
$r=$query->fetch_array();
$snama=$r['nama'];
$scond = array('0','1');
$sfield = $r['status'] ;	
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
							...
							$jmldata=mysql_num_rows($db->query($sqlt));
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
										...
										<?php
											...
											$sqld= $sqld . " aa.produk,aa.status,aa.cabang,case when aa.up='' then 0 else aa.up end sup,aa.createby from tr_sppa aa  ";
											...
											$sqld= $sqld . " left join ms_master ae on ae.msid=ab.status and ae.mstype='STREQ' ";
											if ($vlevel=="checker" or $vlevel=="schecker")
											{
											$sqld= $sqld . "where ab.cabang ='$ucab'";
											}
											
											if ($vlevel=="mkt" )
											{
											$sqld= $sqld . "where ab.createby ='$userid'";
											}	

											if ($vlevel=="smkt" )
											{
											$sqld= $sqld . " where  ab.createby in ";
											$sqld= $sqld . " (select distinct case when a.parent=a.username ";
											$sqld= $sqld . " then a.parent else a.username end from ms_admin a ";
											$sqld= $sqld . " where (a.username='$userid' or a.parent='$userid')) ";
											}											
 											$sqld= $sqld . " order by ab.regid desc limit 100	";
											 /* echo 	$sqld;										  */
											$query=$db->query($sqld);
											$num=$query->num_rows;
											$no=1;
