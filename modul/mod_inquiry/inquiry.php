                    			...
                    			"aoColumns": [
                    			  ...
                    			  null,
                    			  {
                    				"mRender": function ( data, type, full ) {
                    				    ...
                    				    var button = `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="View" href="media.php?module=inquiry&&act=view&&id=`+regid+`"><i class="fa fa-search"></i> View</a>`;
                    				    button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="View Documents" href="media.php?module=doc&&id=`+regid+`"><i class="fa fa-files-o"></i> Doc</a>`;
                    				    
                    				    if ('<?=$vlevel;?>' == 'mkt' || '<?=$vlevel;?>' == 'smkt') {
                    				        if (status == 0) {
                    				            var button = `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" href="media.php?module=ajuan&&act=update&&id=`+regid+`" title="Edit"><i class="fa fa-edit"></i> Edit</a>`;
                    				            button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" href="media.php?module=doc&&id=`+regid+`&&did=01'" title="Upload Dokumen"><i class="fa fa-upload"></i> Doc</a>`;
                    				            button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" href="media.php?module=photo&&act=update&&id=`+regid+`'" title="Upload Foto"><i class="fa fa-upload"></i> Photo</a>`;
                    				            button += `<a class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" href="modul/mod_ajuan/aksi_ajuan.php?module=approve&&id=`+regid+`&&uid=<?=$userid;?>'" title="Approve"><i class="fa fa-check-square"></i> Approve</a>`;
                    				        } else if (status == 11) {
                    				            button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Cetak SPPA" onclick="window.location = 'laporan/sppa/f_sppa.php?id=`+regid+`'"><i class="fa fa-download"></i> SPPA</a>`;
                    				        } else if (['5'].includes(status)) {
                    				            button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Form Pembatalan" href="laporan/batal/f_batal.php?id=`+regid+`&&jenis=batal"><i class="fa fa-download"></i> Batal</button>`;
                    				        } else if (['20'].includes(status)) {
                    				            button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Form Pembatalan" href="laporan/batal/f_batal.php?id=`+regid+`&&jenis=refund"><i class="fa fa-download"></i> Batal</button>`;
                    				        }
                    				        
                    				        if (sertif !== 'null') {
                    				            button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" onclick="window.location = 'laporan/cert/f_cert.php?id=`+regid+`'" title="Cetak Sertifikat"><i class="fa fa-download"></i> Cert</a>`;
                    				        ...
                    				        if ('<?=$vlevel;?>' == 'mkt') {
                    				            button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" href="media.php?module=ajuan&&act=salin&&id=`+regid+`" title="Hubungkan Induk/Talangan/Pasangan"><i class="fa fa-link"></i> Link</a>`;
                    				        }
                    				        ...
                    				        if (status !== '12' && status !== '0') {
                        				        button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Revisi" href="media.php?module=revisi&&act=add&&id=`+regid+`"><i class="fa fa-edit"></i> Revisi</a>`;
                        				        if (status == '5') {
                        				            button += `<a class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" title="Input Tanggal Paid" href="media.php?module=bayar&&act=premi&&before=inquiry&&regid=`+regid+`"><i class="fa fa-money"></i> Paid</a>`;
                        				            button += `<a class="btn btn-xs btn-warning" data-toggle="tooltip" data-placement="top" title="Pembatalan" href="media.php?module=cancel&&act=addcan&&id=`+regid+`"><i class="fa fa-undo"></i> Cancel</a>`;
                        				        }
                        				        
                        				        if (status == '20') {
                        				            button += `<a class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Refund" href="media.php?module=cancel&&act=refund&&id=`+regid+`"><i class="fa fa-undo"></i> Refund</a>`;
                        				            button += `<a class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Claim" href="media.php?module=claim&&act=add&&id=`+regid+`"><i class="fa fa-check"></i> Claim</a>`;
                        				        }
                        				    }
                    				    ...
                    				    button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Log" href="media.php?module=polhist&&act=log&&id=`+regid+`"><i class="fa fa-search"></i> Log</a>`;
                    					return button;
                    				  }
                    			  }
                    			],
