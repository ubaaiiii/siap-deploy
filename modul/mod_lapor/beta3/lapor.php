                     ...
                     <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <div class="x_panel">
                              ...
                              <div class="x_content">
                                 <br />
                                 <form target="parent" action="<?php echo $aksi . "?module=print" ?>" method="post" data-parsley-validate class="form-horizontal form-label-left">
                                       ...
                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                             ...
                                             <div class="control-group">
                                                <div class="controls">
                                                   <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                      <input required type="date" class="form-control has-feedback-left" name="tgl1" placeholder="Masukkan Tanggal" aria-describedby="inputSuccess2Status2">
                                          ...
                                          <fieldset>
                                             <div class="control-group">
                                                <div class="controls">
                                                   <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                      <input required type="date" class="form-control has-feedback-left" name="tgl2" placeholder="Masukkan Tanggal" aria-describedby="inputSuccess2Status3">
                                                      <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-6 col-sm-6 col-xs-5">
                                          <select required class="select2_single form-control" tabindex="-1" name="sfilter1">
                                             <option disabled selected name="t2">Pilih</option>
                                             <?php
                                             $query = $db->query("SELECT msid scode ,msdesc sdesc FROM ms_master where mstype='produk' order by msdesc  ");
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-6 col-sm-6 col-xs-5">
                                          <select required class="select2_single form-control" tabindex="-1" name="sfilter2">
                                             <option disabled selected name="t2">Pilih</option>
                                             <?php
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-6 col-sm-6 col-xs-5">
                                          <select required class="select2_single form-control" tabindex="-1" name="sfilter3">
                                             <option disabled selected name="t2">Pilih</option>
                                             <?php
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-6 col-sm-6 col-xs-5">
                                          <select required class="select2_single form-control" tabindex="-1" name="treport">
                                             <option disabled selected name="t2">Pilih</option>
                                             <?php
