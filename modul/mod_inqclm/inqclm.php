                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
										...
										<?php
											...
											$sqlr= $sqlr . " from tr_sppa aa where aa.regid='0' ";
										...
										?>
                                            <tr>
												...
												<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Log" onclick="window.location='media.php?module=claim&&act=update&&id=<?php echo $r['regid']; ?>'"><i class="fa fa-search"></i> Claim</button>
												</th>
									...
									<?php
							$sqlp="select * from tr_sppa where status in ('5','6') ";
