        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select id="jdoc" class="select2_single input-sm">
                        <?php
                            $dataJDOC = mysql_query("SELECT msid, msdesc FROM ms_master WHERE mstype = 'DOCTYPE' ORDER BY msid ASC");
                            while ($row = mysql_fetch_array($dataJDOC)) {
                        ?>
                        ...
                        $(document).ready(function(){
                    				...
                    				"mRender": function ( data, type, full ) {
                    				    ...
                    				    if (ukuran == 'null') {
                    				        ...
                    				        if (['jpg','png','jpeg'].includes(tipe)) {
                        				        ...
                        				        button += `<a href="https://docs.google.com/gview?url=https://siap-laku.com/bank/`+link+`&embedded=true" target="pdf-frame" class="btn btn-sm btn-default"><i class="fa fa-file-pdf-o"></i> View</a>`;
                    				        }
                    				        if ('<?=$vlevel;?>' != 'insurance') {
                            ...
                            $('#table-doc tbody').on('click', '.btn-upload', function() {
                                <?php
                                    ...
                                    $data = mysql_query("SELECT * FROM ms_master WHERE mstype = 'DOCTYPE' AND msid = '$jenis'");
