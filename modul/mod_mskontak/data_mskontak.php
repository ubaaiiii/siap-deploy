<?php
	...
	$aColumns = array( 'id_contact','nama','nohp','dashboard','kontak','aksi' );
	
	//primary key
	$sIndexColumn = "id_contact";
	
	//nama table database
	$sTable = "(SELECT a.id_contact,
	                   a.nama,
	                   b.nohp,
	                   a.dashboard,
	                   a.kontak,
	                   concat(a.id_contact,'-',a.nama) aksi
                FROM ms_contact a
                INNER JOIN ms_admin b on a.id_contact = b.id_admin) t_baru";
