		 ...
		 $(document).ready(function() {
		  $("#txtcari").keyup(function() {
		   ...
		   $("#tabel_awal").css("display", "none");
			...
			$.ajax({
			 type:"post",
			 url:"modul/mod_rollback/cari.php",
			 data:"q="+ strcari,
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
										...
										<?php
											...
											$sqlr= $sqlr . " where DATEDIFF(now(),aa.createdt)<10 order by aa.regid desc LIMIT $posisi,$batas";
											/* echo $sqlr; */
											$query=$db->query($sqlr);
											$num=$query->num_rows;
											$no=1;
							...
							$sqlp= $sqlp . " left join ms_master ad on aa.status=ad.msid and ad.mstype='STREQ' where  DATEDIFF(now(),aa.createdt)<10 ";
                                ...
                                <div class="x_content">
									...
									<div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="noktp" name="noktp"  readonly  class="form-control col-md-7 col-xs-12" value="<?php echo $r['noktp']; ?>">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            	<select class="select2_single form-control" tabindex="-2" name="status" id="status" onChange="display(this.value)">
												<option value="" selected="selected">-- choose category --</option>
												<?php
												$sqlcmb="select  ms.msid comtabid,msdesc comtab_nm ";
												$sqlcmb= $sqlcmb . "from ms_master ms where ms.mstype='streq'  ";
												$sqlcmb= $sqlcmb . " and msid in (0,1,10,11,12,2,3,4,20) order by ms.mstype ";
												$query=$db->query($sqlcmb);
												while($bariscb=$query->fetch_array()){
												?>
                ...
                <div class="">
                   ...
                   <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Reject <small><?php echo $r['reqid']; ?></small></h2>
