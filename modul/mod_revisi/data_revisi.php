<?php
	...
	$aColumns = array( 'regrev','regid','tglrevisi','jnsrev','createby','dataawal','dataakhir','comment','aksi');
	...
	//nama table database
	$sTable = "(
	    SELECT t.regrev, t.regid, t.tglrevisi, mr.msdesc jnsrev, t.createby, t.dataawal, t.dataakhir, t.comment, t.regid aksi
		FROM tr_sppa_revisi t
		JOIN ms_master mr on mr.msid = t.jnsrev and mr.mstype='REVISI') t_baru";
