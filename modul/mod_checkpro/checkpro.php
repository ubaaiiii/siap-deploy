		 ...
		 $(document).ready(function() {
		  $("#txtcari").keyup(function() {
		   ...
		   $("#tabel_awal").css("display", "none");
			...
			$.ajax({
			 type:"post",
			 url:"modul/mod_checkpro/cari.php",
			 data:"q="+ strcari,
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
										...
										<?php
											...
											$sqlr= $sqlr . " where aa.status='2' order by aa.regid desc LIMIT $posisi,$batas";
											}
											...
											$sqlr= $sqlr . " ,ab.msdesc sts from tr_sppa aa  ";
											$sqlr= $sqlr . " inner join  ms_master ab on aa.status=ab.msid and ab.mstype='STREQ' ";
											$sqlr= $sqlr . " where aa.status='3' order by aa.regid desc LIMIT $posisi,$batas";
											}											
										...
										?>
                                            <tr>
                                                ...
                                                <th>
												<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="View" onclick="window.location='media.php?module=checkpro&&act=update&&id=<?php echo $r['regid']; ?>'"><i class="fa fa-search"></i> View</button>
												<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="document" onclick="window.location='media.php?module=doc&&id=<?php echo $r['regid']; ?>&&did=23'"><i class="fa fa-search"></i> Doc</button>
									...
									<?php
							$sqlp="select * from tr_sppa where status='21' ";
                                ...
                                <div class="x_content">
									...
									<input type="hidden" name="produk" value="<?php echo $sproduk; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
												<textarea readonly name="subject" rows="5" class="textbox" id="subject" style='width: 98%;'><?php echo htmlspecialchars(stripslashes($ssubject)); ?></textarea>                                            
											</div>
                                        </div>
									...
									<table class="table table-bordered">
									 <tbody>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                           	<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Back" onclick="window.location='media.php?module=checkpro'"><i class="fa fa-arrow-left"></i> Back</button>
