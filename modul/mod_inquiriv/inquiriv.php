		 ...
		 $(document).ready(function() {
		  $("#txtcari").keyup(function() {
		   ...
		   $("#tabel_awal").css("display", "none");
			...
			$.ajax({
			 type:"post",
			 url:"modul/mod_inquiriv/cari.php",
			 data:"q="+ strcari,
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
										...
										<?php
											...
											$sqlr= $sqlr . " where ";
											$sqlr= $sqlr . " aa.asuransi in (select cabang from ms_admin  where level='insurance' and username='$userid' ) ";
											$sqlr= $sqlr . " and  LEFT(aa.createdt,10)>=LEFT(date_add(now(), INTERVAL -500 DAY),10) ";
										...
										?>
                                            <tr>
												...
												<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Log" onclick="window.location='media.php?module=polhist&&act=log&&id=<?php echo $r['regid']; ?>'"><i class="fa fa-search"></i> Log</button>
							...
							$sqlp="select aa.regid,aa.nama from tr_sppa aa where ";
							$sqlp= $sqlp . "  aa.asuransi in (select cabang from ms_admin  where level='insurance' and username='$userid' ) ";
							$sqlp= $sqlp . "  and  LEFT(aa.createdt,10)>=LEFT(date_add(now(), INTERVAL -5 DAY),10) ";
...
$sqle= $sqle . " aa.bunga,aa.tunggakan, aa.produk,aa.mitra,aa.comment,aa.asuransi,aa.policyno,ab.paiddt ";
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
										<?php
											$sqll="SELECT a.regid,a.status,a.createby,a.createdt,a.comment, ";
											$sqll=$sqll . " b.msdesc statpol from tr_sppa_log a inner join ms_master b on a.status=b.msid and b.mstype='STREQ' ";
											$sqll=$sqll . " where a.regid='$sid'  order by createdt desc ";
											/* echo $sqll; */
