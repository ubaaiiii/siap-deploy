    ...
    $(document).ready(function() {
        $("#txtcari").keyup(function() {
            ...
            if (strcari != "") {
                ...
                $.ajax({
                    type: "post",
                    url: "modul/mod_inquirib/cari.php",
                    data: "q=" + strcari,
...
?>
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="row">                                             <!-- Inquirib yang baru -->
                <table id="table-inquirib" class="table table-bordered" cellspacing="0" width="100%">
                    <thead>
                      <tr class="headings">
                  ...
                  <script>
                	$(document).ready(function() {
                	    $('#table-inquirib tfoot th').each( function () {
                            var title = $(this).text();
                            $(this).html( '<input type="text" placeholder="'+title+'" />' );
                        } );
                		$('#table-inquirib').dataTable( {
                		    "colReorder": true,
                		    "autoWidth": false,
                		    "responsive": true,
                			"bProcessing": true,
                			"bServerSide": true,
                			"sAjaxSource": "modul/mod_inquirib/data_inquirib.php",
                			"aoColumns": [
                			  {"sName": "cabang"},
                			  {"sName": "produk"},
                			  {"sName": "createby"},
                			  ...
                			  null,
                			  {
                				"mRender": function ( data, type, full ) {
                				    ...
                				    var regid = data[0];
                				    var status = data[1];
                				    var button = `<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="View" onclick="window.location='media.php?module=inquirib&&act=view&&id=`+regid+`'"><i class="fa fa-search"></i> View</button>`;
                				    if (status !== '12') {
                				        if (status !== '0') {
                				            button += `<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Revisi" onclick="window.location='media.php?module=revisi&&act=add&&id=`+regid+`'"><i class="fa fa-edit"></i> Revisi</button>`;
                				        }
                				    }
                				    button += `<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Log" onclick="window.location='media.php?module=polhist&&act=log&&id=`+regid+`'"><i class="fa fa-search"></i> Log</button>`;
                					return button;
                				  }
                			  }
                			],
                                ...
                                <form method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $aksi." ?module=update "; ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Back" onclick="window.location='media.php?module=inquirib'"><i class="fa fa-arrow-left"></i> Back</button>
