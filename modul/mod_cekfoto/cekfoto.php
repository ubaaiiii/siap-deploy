	...
	<div class="right_col" role="main">
		<div class="">
			...
			<div class="row">
								...
								while($r=$query->fetch_array()){
									...
									<tr>
										...
										<th>
											...
											<button type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Reject" onclick="window.location='<?php echo $aksi."?module=reject&&id=".$r['regid']  . "&&uid=".$userid; ; ?>'"><i class="fa fa-trash"></i> Reject</button>
				...
				// 	$jmldata=mysql_num_rows($db->query($sqlp));
							...
							<div id="tabel_doc">
								...
								<div class="form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
										...
										<button type="button" class="btn btn-sm btn-default" onclick="window.location='media.php?module=revisi&&act=add&&id=<?=$sid;?>'"><i class="fa fa-search"></i> Revisi</button>
										<button type="submit" class="btn btn-sm btn-info">Submit</button>
										<button type="button" class="btn btn-sm btn-danger" onclick="window.location='<?=$aksi."?module=reject&&id=".$sid."&&uid=".$userid; ?>'"><i class="fa fa-trash"></i> Reject</button>
