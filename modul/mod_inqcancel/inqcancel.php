                ...
                <div style="width:100%;overflow-x:auto;">
                    ...
                    <script>
                        $(document).ready(function(){
                            var tableInqClaim = $('#table-inqclm').dataTable({
                                "colReorder": true,
                                "scrollX": true,
                                "scrollY": false,
                    		    "autoWidth": true,
                    			"processing": true,
                    			"serverSide": true,
                    			"ajaxSource": "modul/mod_inqcancel/data_inqcancel.php",
                    			"serverMethod": 'POST',
                    			"aoColumns": [
                    			  {"sName": "regid"},
                    			  {"sName": "produk"},
                    			  ...
                    			  {"name": "status"},
                    			  {
                    				"render": function ( data, type, full ) {
                    				    ...
                    				    var button = `<a class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="View" href="media.php?module=inqclm&&act=view&&id=`+regid+`"><i class="fa fa-search"></i> view</a>`;
                    				    if (status == '5' || status == '6') {
                    				        button += `<a class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Cancel" href="media.php?module=cancel&&act=addcan&&id=`+regid+`"><i class="fa fa-times"></i> Cancel</a>`;
                    				    } else if (status == '20') {
                    				        button += `<a class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Refund" href="media.php?module=cancel&&act=refund&&id=`+regid+`"><i class="fa fa-money"></i> Refund</a>`;
                    				    }
                                ...
                                initComplete: function(){
                                    $('#table-inqclm_filter input').unbind();
                                    
                                    $("#table-inqclm_filter input").keyup(function(e) {
                                        if (e.keyCode == 13) {
                                            tableInqClaim.fnFilter(this.value);
                                        }
                                    });
                                },
                            });
                                    ...
                                    success: function(data) {
                                        if (data != 0) {
                                            Swal.fire(
                                                ...
                                                'Harap menghubungi Team BDS untuk pengecekan selanjutnya',
                                                'error'
                                            ).then(function(){
