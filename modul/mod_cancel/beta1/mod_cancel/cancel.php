                			  ...
                			  {                         // full[9]
                				"mRender": function ( data, type, full, meta ) {
            				        ...
            				        if( ["72", "73", "82", "83"].includes(status) ){
                				        ...
                				        if ( '<?=$vlevel;?>' !== 'insurance') {
                    				        button += `<a style="display: inline-block;" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Edit" href="media.php?module=cancel&&act=update&&id=`+full[10]+`"><i class="fa fa-edit"></i> Edit</button>`;
                				        }
                				    }
                				    ...
                				    button += `<a style="display: inline-block;" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Edit" href="media.php?module=cancel&&act=view&&id=`+full[10]+`"><i class="fa fa-search"></i> View</a>`;
                				    button += `<a style="display: inline-block;" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="View Documents" href="media.php?module=doc&&id=`+full[10]+`&&jenis=`+jdoc+`"><i class="fa fa-files-o"></i> Doc</a>`;
                				    ...
                				    if ( '<?=$vlevel;?>' == 'schecker' && ["7", "8"].includes(status) ) {
                				        button += `<a style="display: inline-block;" class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" title="Approve" href="<?=$aksi."?module=approve&&regid=";?>`+full[10]+`"><i class="fa fa-check-circle"></i> Approve</a>`;
                				        
                				    } else if ('<?=$vlevel;?>' == 'broker') {
            				            if( ["7", "8", "71", "81"].includes(status) ){
                				            button += `<a style="display: inline-block;" class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" title="Approve" href="<?=$aksi."?module=approve&&regid=";?>`+full[10]+`"><i class="fa fa-check-circle"></i> Approve</a>`;
            				                if( ["7", "71"].includes(status) ){
                				                button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Form Pembatalan" href="https://docs.google.com/gview?url=https://siap-laku.com/bank/laporan/batal/f_batal.php?id=`+full[10]+`&&jenis=batal" target="_blank"><i class="fa fa-download"></i> Batal</button>`;
                				            } else if( ["8", "81"].includes(status) ){
                				                button += `<a class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Form Pembatalan" href="https://docs.google.com/gview?url=https://siap-laku.com/bank/laporan/batal/f_batal.php?id=`+full[10]+`&&jenis=refund" target="_blank"><i class="fa fa-download"></i> Batal</button>`;
                				            }
                				        } else if (status == 83) {
                				        ...
                				        if (status == 84) {
                				            if (bordero == 'YES') {
                				                button += `<a style="display: inline-block;" class="btn-paid btn btn-xs btn-success" data-id="`+full[10]+`" data-toggle="tooltip" data-placement="top" title="Pembayaran Refund"><i class="fa fa-calendar"></i> Paid</a>`;
                				            }
                				        } else if( ["72", "82"].includes(status) ){
                				            button += `<a style="display: inline-block;" class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" title="Approve" href="<?=$aksi."?module=approve&&regid=";?>`+full[10]+`"><i class="fa fa-check-circle"></i> Approve</a>`;
                    				        // button += `<a style="display: inline-block;" class="btn-rollback btn btn-xs btn-warning" data-toggle="tooltip" data-placement="top" title="Rollback" d-id="`+full[10]+`"><i class="fa fa-undo"></i> Rollback</a>`;
                				        }
                				    ...
                				    button += `<a style="display: inline-block;" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Pembayaran Claim" href="media.php?module=polhist&&act=log&&type=`+typeLog+`&&id=`+full[10]+`"><i class="fa fa-history"></i> Log</a>`;
