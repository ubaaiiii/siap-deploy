		 ...
		 $(document).ready(function() {
		  $("#txtcari").keyup(function() {
		   ...
		   $("#tabel_awal").css("display", "none");
			...
			$.ajax({
			 type:"post",
			 url:"modul/mod_clmverif/cari.php",
			 data:"q="+ strcari,
...
$aksi="modul/mod_clmverif/aksi_clmverif.php";
$judul="Claim Verifikasi";
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
										...
										?>
                                            <tr>
                                                ...
                                                <th>
												<button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Edit" onclick="window.location='media.php?module=clmverif&&act=update&&id=<?php echo $r['regclaim']; ?>'"><i class="fa fa-search"></i> view</button>
									...
									<?php
							$sqlp="select * from tr_sppa a inner join tr_claim b on a.regid=b.regid and a.status='91' ";
                                ...
                                <div class="x_content">
									...
									<input type="hidden" name="regid" value="<?php echo $sregid; ?>">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="nilaios" name="nilaios"    required="required" class="form-control col-md-7 col-xs-12" value="<?php echo number_format($r['nilaios'],0); ?>" >
