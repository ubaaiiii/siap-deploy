                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
										...
										<?php
											...
											$sqlr="select left(a.mulai,7) syear , count(1) sdat,sum(a.premi) samt1, sum(a.epremi) samt2,sum(a.tpremi) samt3 from tr_sppa a ";
											$sqlr= $sqlr . "  group by left(a.mulai,7)   desc LIMIT $posisi,$batas";
											/* echo $sqlr; */
									...
									<?php
							$sqlp="select left(a.mulai,7) syear , count(1) sdat,sum(a.premi) samt1, sum(a.epremi) samt2,sum(a.tpremi) samt3 from tr_sppa a ";
							$sqlp= $sqlp . "  group by left(a.mulai,7)  ";
