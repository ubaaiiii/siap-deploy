...
$aksi="modul/mod_mscab/aksi_mscab.php";
$judul="Master Cabang";
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
										<?php
											$query=$db->query("SELECT * from ms_master where mstype='CAB' order by msid ASC LIMIT $posisi,$batas");
											$num=$query->num_rows;
											$no=1;
									...
									<?php
							$jmldata=mysql_num_rows($db->query("SELECT * from ms_master where mstype='CAB'  "));
                ...
                <div class="">
                   ...
                   <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Update <small><?php echo $r['itemid']; ?></small></h2>
