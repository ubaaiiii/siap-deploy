                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
										...
										<?php
											...
											$sqlr= $sqlr . "  where aa.status in ('10')  ";
										...
										?>
                                            <tr>
                                                ...
                                                <th>
												<button type="button" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Validasi" onclick="window.location='media.php?module=valid&&act=update&&id=<?php echo $r['regid']; ?>'"><i class="fa fa-check-square"></i> Validasi</button>
												<button type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Reject" onclick="window.location='media.php?module=valid&&act=reject&&id=<?php echo $r['regid']; ?>'"><i class="fa fa-times-circle"></i> Reject</button>
									...
									<?php
							$sqlp="select aa.regid from tr_sppa aa where aa.status in ('10') ";
