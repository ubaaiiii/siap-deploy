	...
	<body>
		<div class="page">
			...
			<tr>
				...
				?>
							<H3></H3>
							<H3 align="right">PREMIUM NOTES</H3>
		...
		<?php
				...
				$ssql= $ssql . " ,mp.msdesc object,a.up,a.masa,a.regid   from tr_sppa a ";
				$ssql= $ssql . " inner join tr_billing b on a.policyno=b.policyno ";
				$ssql= $ssql . " inner join ms_master mp on mp.msid=a.produk and mp.mstype='produk' ";
				$ssql= $ssql . " where a.policyno='$spolicyno' ";
				//echo $sqlm;
