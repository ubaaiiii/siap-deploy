...
$sbillno='00038/TKP/DN/07/03/18';
			...
			$sno==0;
            //start -----detail data ------------------
            $sql = "SELECT a.* from tr_billing a  where  a.billno='$sbillno' "; 
			...
			//body report 
				...
				$ssql="select '1234.5678.9' policyno,'Bank Bukopin' clientname ,'Asuransi Kredit' instype  , 'terlampir' speriod3, ";
				$ssql= $ssql . " 'terlampir' object,a.grossamt,a.admamt,a.dutycostamt,a.discamt ,a.totalamt,a.billno,a.billdt ";
				$ssql= $ssql . " from  tr_billing a  where a.billno='$sbillno' ";
				/* echo $ssql; */
				...
				$sdate="Jakarta , ". $sdate ; 
				$sinvoceno= "No Nota  : " . $r['billno'] ;
				$billtype= "PREMIUM NOTES";
				$billdt=  " Tanggal : " . tglindo_yyyymmdd($r['billdt']) ;
			...
			$pdf->setXY(10, $yh+17); 
			$pdf->Cell(30,10,$snopol1);
			
			$pdf->setXY(10, $yh+22); 
            $pdf->Cell(30,10,$snopol2);
			
			$pdf->setXY(50, $yh+20); 
            $pdf->Cell(30,10,$snopol3);
			...
			$pdf->setXY(50, $yh+32); 
            $pdf->Cell(30,10,$sname3);
			
			$pdf->setXY(10, $yh+41); 
			$pdf->Cell(30,10,$scob1);
			
			
			$pdf->setXY(10, $yh+46); 
			$pdf->Cell(30,10,$scob2);
